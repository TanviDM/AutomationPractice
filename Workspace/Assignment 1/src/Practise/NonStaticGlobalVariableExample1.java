package Practise;
 ...
 class NonStaticGlobalVariableExample1 {
		...
		public static void main(String[] args) 
		{
			...
			/* 
			NonStaticGlobalVariableExample1 n1;//----> object is not created, we have just declared the object
	...
	* to access non-static member, first we need load them into the memory by creating an 
	* instance/object of class
		Syntax to create an object:
		(will be created in the Heap memory which is a random storage area)
		...
		* NSGV we will multiple copies in the memory allocation depending on objection
