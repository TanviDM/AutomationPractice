package Practise;
	...
	class StaticGlobalVariableExample1 
	{
		...
		public static void main(String[] args) 
		{
			...
			System.out.println("SGV std empId: "+StaticGlobalVariableExample1.empId);
			System.out.println("SGV std salary: "+StaticGlobalVariableExample1.salary);
			System.out.println("**************Updated SGV******************");
			
			empId=1002;//re-initialize
			result=true;//StaticGlobalVariableExample2.result=true;
			StaticGlobalVariableExample1.salary=25000.26;//re-initialize
